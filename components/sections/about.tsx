          ...
          >
            <div className="bg-card p-8 rounded-lg border border-border hover:border-accent/50 transition-all duration-300 backdrop-blur-sm bg-opacity-50">
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                લાલો એ કૃષ્ણનો ભક્તિ, તેમના સમર્પણ અને નિયતિના માર્ગે તેમની પ્રવાહમાન બોધ વર્ણન કરે છે. આ અનંત પ્રેમની કથા મણીને એક
                માનવીય સ્વર આપે છે.
              </p>
            </div>
            ...
            <div className="bg-card p-8 rounded-lg border border-border hover:border-accent/50 transition-all duration-300 backdrop-blur-sm bg-opacity-50">
              ...
              <p className="text-foreground/80 leading-relaxed">
                Laalo is a cinematic exploration of devotion and divine destiny, following a journey through spiritual
                awakening. The story delves into themes of faith, sacrifice, and the eternal bond between the soul and
                the divine, set against the rich cultural backdrop of Gujarat.
              </p>
            </div>
          </div>
